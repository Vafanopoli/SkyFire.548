...
enum LfgUpdateType
{
	...
	LFG_UPDATETYPE_PROPOSAL_FAILED				 = 2,	// --
	LFG_UPDATETYPE_PROPOSAL_DECLINED			 = 3,	// --
	LFG_UPDATETYPE_PARTY_ROLE_NOT_AVAILABLE		 = 4,	// --
	LFG_UPDATETYPE_ROLECHECK_ABORTED			 = 5,	// --
    LFG_UPDATETYPE_ROLECHECK_FAILED              = 6,	// --
	LFG_UPDATETYPE_GROUP_FOUND					 = 7,	// --
    LFG_UPDATETYPE_REMOVED_FROM_QUEUE            = 8,	// ++ ok
	LFG_UPDATETYPE_DUNGEON_FINISHED				 = 9,	// --
	LFG_UPDATETYPE_GROUP_MEMBER_OFFLINE			 = 10,	// --
	LFG_UPDATETYPE_PROPOSAL_BEGIN				 = 11,	// ++ ok
	LFG_UPDATETYPE_GROUP_DISBAND_UNK16			 = 12,	// - FIXME: Sometimes at group disband
	LFG_UPDATETYPE_JOIN_QUEUE					 = 13,	// ++ ok
	LFG_UPDATETYPE_ADDED_TO_QUEUE				 = 24,	// ++ ok
	LFG_UPDATETYPE_JOIN_LFG_OBJECT_FAILED		 = 45,	// --
	LFG_UPDATETYPE_UPDATE_STATUS				 = 52,	// ++ ok
};
