...
class Group
{
    ...
    public:
        ...
        std::size_t GetMembersCount() const { return m_memberSlots.size(); }
        ...
        GroupJoinBattlegroundResult CanJoinBattlegroundQueue(Battleground const* bgOrTemplate, BattlegroundQueueTypeId bgQueueTypeId, std::size_t MinPlayerCount, std::size_t MaxPlayerCount, bool isRated, uint32 arenaSlot);
