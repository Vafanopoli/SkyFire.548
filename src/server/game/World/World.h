...
class World
{
    public:
        ...
        std::size_t GetActiveAndQueuedSessionCount() const { return m_sessions.size(); }
        std::size_t GetActiveSessionCount() const { return m_sessions.size() - m_QueuedPlayer.size(); }
        std::size_t GetQueuedSessionCount() const { return m_QueuedPlayer.size(); }
